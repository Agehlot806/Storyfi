                    ...
                    <View>
                        <View style={{ height: moderateScale(90), width: "90%", marginLeft: scale(15), alignItems: "center", flexDirection: "row" }}>
                            <View style={styles.contare1}>
                                <View style={styles.contare1}>
                                    <Image
                                        style={{ width: moderateScale(80), height: moderateScale(80), marginLeft: scale(18) }}
                                        source={{ uri: "https://media.tenor.com/ocC1rizLyVoAAAAj/dry-january-no-drinking.gif" }}
                                    />
                                </View>
                            </View>
                            <View style={styles.contare1}>
                                <Image
                                    style={{ width: moderateScale(120), height: moderateScale(100), marginLeft: scale(18) }}
